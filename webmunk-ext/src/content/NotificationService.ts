  ...
  private displayNotification(text: string): void {
    ...
    const notificationContent = `
      <div style="display: flex; align-items: center; justify-content: space-between;">
        <p style="font-size: 22px; font-weight: 700; color: black; margin: 0; line-height: 1.3;">Ad Study Notification</p>
      ...
      <p style="font-size: 18px; color: black; font-weight: 700; margin: 0; line-height: 1.3; text-align: center; white-space: break-spaces;">${text}</p>
    `;
