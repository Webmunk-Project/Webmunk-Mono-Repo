...
class PSelectorHasTextInShadowTask extends PSelectorTask {
    constructor(task) {
        super();
    ...
    transpose(node, output) {
        ...
        try{
            if ( shadowRoot && this.needle.test(shadowRoot.textContent) ) {
                output.push(node);
            }
        }
        catch(e){
            console.log("EXCEPTION: PSelectorHasTextInShadowTask.transpose ",e)
        }
    }
}
...
PSelector.prototype.operatorToTaskMap = new Map([
    ...
    [ 'has-text-in-shadow', PSelectorHasTextInShadowTask],
    [ 'if', PSelectorIfTask ],
