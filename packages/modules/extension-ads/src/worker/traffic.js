...
const onBeforeRequest = function(details, internal = false) {
    ...
    if ( fctxt.itype === fctxt.MAIN_FRAME ) {
        return onBeforeRootFrameRequest(fctxt, internal);
    }

    // Special treatment: behind-the-scene requests
    const tabId = details.tabId;
    if ( tabId < 0 ) {
        return onBeforeBehindTheSceneRequest(fctxt, internal);
    }
...
const onBeforeRootFrameRequest = function(fctxt, internal) {
