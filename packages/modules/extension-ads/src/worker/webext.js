...
const webext = {
    ...
    browserAction: {
        setBadgeBackgroundColor: ()=>{}, //TODO promisifyNoFail(chrome.browserAction, 'setBadgeBackgroundColor'),
        setBadgeText: ()=>{}, //TODO promisifyNoFail(chrome.browserAction, 'setBadgeText'),
        setIcon: ()=>{}, //TODO promisifyNoFail(chrome.browserAction, 'setIcon'),
        setTitle: ()=>{}, //TODO promisifyNoFail(chrome.browserAction, 'setTitle'),
    },
